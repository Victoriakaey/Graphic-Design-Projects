...
class Vector3 {
    ...
    add(other) {
        ...
        // this.elements = other.elements + this.elements;
    ...
    static cross(other1, other2) {
        ...
        v3.elements[0] = (other1.elements[1] * other2.elements[2]) - (other1.elements[2] * other2.elements[1]); // aybz - azby // since z is all 0
        v3.elements[1] = (other1.elements[2] * other2.elements[0]) - (other1.elements[0] * other2.elements[2]); // azbx - axbz // since z is all 0
        v3.elements[2] = (other1.elements[0] * other2.elements[1]) - (other1.elements[1] * other2.elements[0]); // axby - aybx
        // Don't delete the return statement.
        return v3;
    }
